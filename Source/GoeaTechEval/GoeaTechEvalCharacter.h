...
protected:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "My Input")
	bool IsAttacking;
...
public:
	...
	UFUNCTION(BlueprintPure)
	FORCEINLINE UCustomCharacterMovementComponent*& GetCustomCharacterMovementReference() { return MovementComponent; }
};
